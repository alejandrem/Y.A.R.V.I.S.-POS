// ============================================================
// movimientos — Entradas/retiros manuales de caja y consultas por
// cajero. (Movido desde adminfinanzas/cortes/movimientos.rs sin
// cambios de lógica: ese archivo hoy es solo un shim.)
// ============================================================
