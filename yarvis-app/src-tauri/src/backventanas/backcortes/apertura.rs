// ============================================================
// apertura — Apertura manual de cortes X y Z (flujo admin legacy,
// movido desde adminfinanzas/cortes/creacion.rs sin cambios de
// lógica: ese archivo hoy es solo un shim de re-export).
// ============================================================
//
