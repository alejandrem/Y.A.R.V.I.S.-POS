    ...
    <div className="max-w-6xl animate-in fade-in slide-in-from-bottom-2 duration-500 mx-auto space-y-12">
      <header className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-[10px] font-black text-neutral-400 uppercase tracking-[0.3em]">Consulta de Stock y Alertas</p>
        </div>
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-neutral-50">
            {sortedInventory.map((item, idx) => {
              ...
              return (
                <tr key={item.id || idx} className="group hover:bg-neutral-50/30 transition-all">
