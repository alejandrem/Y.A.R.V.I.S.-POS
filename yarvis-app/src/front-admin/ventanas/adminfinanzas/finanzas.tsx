const AdminFinanzas = () => (
  <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-2 duration-500 mx-auto">
    <header className="mb-10 text-center">
      <h2 className="text-3xl font-black text-neutral-900 uppercase tracking-tight mb-2">FINANZAS</h2>
    ...
    <div className="bg-neutral-50 p-10 rounded-[2.5rem] border border-neutral-100 shadow-inner">
      <p className="text-xl text-neutral-600 font-light leading-relaxed first-letter:text-4xl first-letter:font-black first-letter:text-neutral-900">
        Aqui si veremos las graficas complejas y completas de cada seccion controlaremos todos los Cortes de caja (X y Z) visualizando todos los que se han hecho tambien las graficas de Utilidad bruta, Utilidad Operativa, Utilidad Neta, Utilidad Marginal.
      </p>
    </div>
  </div>
);
