...
React &nbsp;·&nbsp; Rust &nbsp;·&nbsp; Tauri 2 &nbsp;·&nbsp; SQLite &nbsp;·&nbsp; Qwen2.5-Coder 1.5B local + Opencode zen.

<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg> Licencia **GPL-3.0-or-later** — libre, copyleft fuerte.
...
<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg> **Chat cloud (OpenCode Zen/Gemini) con fallback local (Qwen2.5-Coder 1.5B)**.
