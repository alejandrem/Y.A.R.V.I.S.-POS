// Suite de integración del parseador masivo: cada test levanta su DB
// temporal, importa tickets de verdad y verifica ventas, detalles,
// stock e idempotencia al centavo.
